                            ...
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        @else
                                            <div class="rounded d-flex align-items-center justify-content-center text-white" style="width:44px;height:44px;background:linear-gradient(135deg,#047857,#047857);">
